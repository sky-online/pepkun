...
- voiceCues：実際にコーチが口に出す具体的なセリフを3〜5個。短く・即使える言葉で
- troubleshooting：練習中に起きがちな問題と、その場でできる改善策を2〜3個
- freezeMoments：練習を一時停止して全体に声をかけるタイミングと、そのとき伝える内容を1〜2個
...
const DRILL_SCHEMA = `{
  ...
  "voiceCues": ["選手への声かけ例（そのまま言えるセリフ）×3〜5個"],
  "troubleshooting": [
    {"problem": "起きがちな問題・うまくいかない現象", "solution": "その場でできる改善策"}
  ],
  "freezeMoments": [
    {"trigger": "練習を止めるタイミング・現象", "coaching": "止めたときに全体へ伝える内容"}
  ],
